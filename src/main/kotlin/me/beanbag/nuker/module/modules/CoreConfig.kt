...
object CoreConfig : Module("${ModConfigs.MOD_NAME} Core Configs", "General configs that apply to systems running ${ModConfigs.MOD_NAME}") {
    ...
    val staticFillColour by setting(this.breakingRender, "Static Fill Colour", "The colour used to render the static fill of the box faces", Color.RED, null) { renders.enabled() && renders != RenderType.Line && fillColourMode == ColourMode.Static }
    val startFillColour by setting(this.breakingRender, "Start Fill Colour", "The colour used to render the start fill of the box faces", Color.RED, null) { renders.enabled() && renders != RenderType.Line && fillColourMode == ColourMode.Dynamic }
    val endFillColour by setting(this.breakingRender, "End Fill Colour", "The colour used to render the end fill of the box faces", Color.GREEN, null) { renders.enabled() && renders != RenderType.Line && fillColourMode == ColourMode.Dynamic }
