...
abstract class Module(var name: String, var description: String, private var alwaysListening: Boolean = false, priority: HandlerPriority = HandlerPriority.normal()) : IJsonable,
    IHandlerController {
