...
object CoreConfig : Module("${ModConfigs.MOD_NAME} Core Configs", "General configs that apply to systems running ${ModConfigs.MOD_NAME}") {
    ...
    val packetLimit by setting(breaking, "Packet Limit", "How many packets can be sent per tick", 10, null, { true }, 0, 15, 0, 15)
    ...
    val staticFillColour by setting(this.breakingRender, "Static Fill Colour", "The colour used to render the static fill of the box faces", Color(1.0f, 0.0f, 0.0f, 0.22f).brighter(), null) { renders.enabled() && renders != RenderType.Line && fillColourMode == ColourMode.Static }
    val startFillColour by setting(this.breakingRender, "Start Fill Colour", "The colour used to render the start fill of the box faces", Color(1.0f, 0.0f, 0.0f, 0.22f).brighter(), null) { renders.enabled() && renders != RenderType.Line && fillColourMode == ColourMode.Dynamic }
    val endFillColour by setting(this.breakingRender, "End Fill Colour", "The colour used to render the end fill of the box faces", Color(0.0f, 1.0f, 0.0f, 0.22f).brighter(), null) { renders.enabled() && renders != RenderType.Line && fillColourMode == ColourMode.Dynamic }
    ...
    val staticOutlineColour by setting(this.breakingRender, "Static Outline Colour", "The colour used to render the outline of the box", Color.RED.brighter(), null) { renders.enabled() && renders != RenderType.Fill && outlineColourMode == ColourMode.Static }
    val startOutlineColour by setting(this.breakingRender, "Start Outline Colour", "The colour used to render the start outline of the box", Color.RED.brighter(), null) { renders.enabled() && renders != RenderType.Fill && outlineColourMode == ColourMode.Dynamic }
    val endOutlineColour by setting(this.breakingRender, "End Outline Colour", "The colour used to render the end outline of the box", Color.GREEN.brighter(), null) { renders.enabled() && renders != RenderType.Fill && outlineColourMode == ColourMode.Dynamic }
