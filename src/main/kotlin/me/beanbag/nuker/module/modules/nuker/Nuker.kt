...
import me.beanbag.nuker.module.modules.nuker.handlers.BreakingHandler.blockTimeouts
import me.beanbag.nuker.module.modules.nuker.handlers.BreakingHandler.checkAttemptBreaks
import me.beanbag.nuker.module.modules.nuker.handlers.BreakingHandler.updateBreakingContexts
import me.beanbag.nuker.module.modules.nuker.handlers.BreakingHandler
import me.beanbag.nuker.module.modules.nuker.handlers.BrokenBlockHandler
...
object Nuker : Module("Epic Nuker", "Epic nuker for nuking terrain") {
    ...
    val ghostBlockTimeout by setting(generalGroup, "Ghost Block Timeout (Ticks)", "The delay after breaking a block to reset its state if the server hasn't validated the break", 30, null, { validateBreak }, 5, 50, 5, 50)
    ...
    val packetLimit by setting(generalGroup, "Packet Limit", "How many packets can be sent per tick", 8, null, { true }, 0, 15, 0, 15)
    val blockTimeout by setting(generalGroup, "Block Timeout (Ticks)", "The delay after breaking a block to attempt to break it again", 20, null, { true }, 0, 100, 0, 100)
