...
object CoreConfig : Module("Core Configs", "General configs") {
    ...
    val startFillColour by setting(
        breakingRender,
        "Start Fill Colour",
    ...
    val startOutlineColour by setting(
        breakingRender,
    ...
    val endOutlineColour by setting(
        breakingRender,
        "End Outline Colour",
